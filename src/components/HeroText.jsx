...
function HeroText() {
    ...
    return(
        <div className="group flex flex-row items-center h-32 absolute top-96 z-10 left-16 justify-center text-6xl sm:text-4xl md:text-3xl w-full text-white" to="/">
            <svg className='w-full h-full text-8xl' viewBox="0 0 700 110" xmlns="http://www.w3.org/2000/svg" >
                <animated.svg fillOpacity={fillMe} strokeDasharray={400} strokeDashoffset={x1.to(x1 => (1-x1) * 400)}> {/* B */}
                        <text x="0" y="80" stroke="white" fill="white">
