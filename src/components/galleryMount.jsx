...
const GalleryMount = ({toggle, set, target}) => {
    ...
    return GalleryStyle((styles, item) => item && <animated.div style={{...styles}} className="fixed w-screen h-screen flex flex-row items-center justify-center z-20" onClick={() => set(false)}>
